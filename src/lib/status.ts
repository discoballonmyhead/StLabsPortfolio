...
const map: Record<ProjectStatus, { fg: string; bg: string; bd: string }> = {
  ...
  Defunct: { fg: '#555', bg: 'rgba(80,80,80,0.10)', bd: 'rgba(80,80,80,0.22)' },
  Abandoned: { fg: '#555', bg: 'rgba(80,80,80,0.10)', bd: 'rgba(80,80,80,0.22)' },
  Discontinued: { fg: '#664433', bg: 'rgba(102,68,51,0.10)', bd: 'rgba(102,68,51,0.22)' },
}
